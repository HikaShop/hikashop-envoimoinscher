...
class Env_Quotation extends Env_WebService {
	 ...
	 * "description_fr" => "la description fran�aise pour ce produit", "origine" => "FR",
	 * "number" => 2, "value" => 500)));
...
// TODO : enlever cette validation apr�s avoir d�tect� pourquoi il multiplie le nombre des nodes par 2
				...
				// Ajout de l'insurance si elle est retourn�e
